...
vdem.nodems <- read.csv("./vdem-2018-no-dems-parcomp-post1945-oct2020-condensed-tidy.csv")
...
model.elirreg.negshockmajor.oppover <-  
        lm(v2elirreg.inv~reform_positive.lag +
         ...
         reform_positive.lag*opposition.oversight.lag   + elexec + 
                                              ...
                                              loggpdpc.lag  
                                              #e_miurbani + 
                                               + v2elintmon + v2elparlel_1 + v2elparlel_2  + reform_negative.lag +    COW.factor
...
p.cbps.irreg.elcomp <- interplot(model.elirreg.negshockmajor.polity, var1="reform_positive.lag", var2="elcompindex.m.lag",
                              hist=TRUE, adjCI = TRUE) + theme_bw() + labs(x="Lagged adjusted Polity score", y="Marginal effect",
                                                             title="Marginal effect of positive judicial reform \non voting irregularities") +
  geom_hline(yintercept=0, linetype=2) 
...
```{r cbps polity}
myvars <- c("COW.factor", "v2elirreg.inv", "democracy.duration.2lag", "oppaut.2lag",  "uds.mean.2lag", "uds.mean.lag", "v2elintmon", "v2elparlel_1", "v2elparlel_2", "reform_negative.lag",
            "loggpdpc.2lag", "urban.2lag",
            "hc.ind.2lag",  "lc.ind.2lag", "transitional", "exec.respectcon.2lag", "altinfo.2lag", "education.2lag",
            "leg.constraints.2lag", "reform_positive.lag", "elexec", "loggpdpc.2lag", "loggpdpc.lag")
