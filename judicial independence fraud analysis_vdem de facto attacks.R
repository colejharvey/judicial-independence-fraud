###Analysis script
###VDEM attacks on the judiciary (purges and packs)
###July 2019
...
vdem.nodems$defacto.attack.lag <- vdem.nodems$pack_major.lag + vdem.nodems$purge_major.lag
vdem.nodems$defacto.attack.lag[vdem.nodems$defacto.attack.lag == 2] <- 1
...
##Core civil society
mm.elirreg.base.raw <- lmer(v2elirreg.inv~defacto.attack.lag + v2xcs_ccsi +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elirreg.ccsi.raw <- lmer(v2elirreg.inv~defacto.attack.lag + v2xcs_ccsi + 
                              defacto.attack.lag:v2xcs_ccsi +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
interplot(mm.elirreg.ccsi.raw, var1="defacto.attack.lag", var2="v2xcs_ccsi") #CS openness + attack = more fraud


####

mm.elintim.base.raw <- lmer(v2elintim.inv~defacto.attack.lag + v2xcs_ccsi +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elintim.ccsi.raw <- lmer(v2elintim.inv~defacto.attack.lag + v2xcs_ccsi + 
                              defacto.attack.lag:v2xcs_ccsi +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
...
interplot(mm.elintim.ccsi.raw, var1="defacto.attack.lag", var2="v2xcs_ccsi") #When CC independence is low, attack on courts -> more intimidation than when no change
...
mm.elirreg.base.raw <- lmer(v2elirreg.inv~defacto.attack.lag + lowchamb.second.seatshare.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elirreg.ss.raw <- lmer(v2elirreg.inv~defacto.attack.lag + lowchamb.second.seatshare.lag + 
                            defacto.attack.lag:lowchamb.second.seatshare.lag +
                            elexec + #e_peaveduc+ 
                            e_polity2 +
                            e_migdppcln + 
                            e_miurbani + 
...
interplot(mm.elirreg.ss.raw, var1="defacto.attack.lag", var2="lowchamb.second.seatshare.lag") #No interaction


##Engaged society
mm.elirreg.base.raw <- lmer(v2elirreg.inv~defacto.attack.lag + engaged.society.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elirreg.engaged.raw <- lmer(v2elirreg.inv~defacto.attack.lag + engaged.society.lag + 
                                 defacto.attack.lag:engaged.society.lag +
                                 elexec + #e_peaveduc+ 
                                 e_polity2 +
                                 e_migdppcln + 
                                 e_miurbani + 
...
interplot(mm.elirreg.engaged.raw, var1="defacto.attack.lag", var2="engaged.society.lag") #Increase in JI = less fraud in less open societies

###

mm.elintim.base.raw <- lmer(v2elintim.inv~defacto.attack.lag + engaged.society.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elintim.engaged.raw <- lmer(v2elintim.inv~defacto.attack.lag + engaged.society.lag + 
                                 defacto.attack.lag:engaged.society.lag +
                                 elexec + #e_peaveduc+ 
                                 e_polity2 +
                                 e_migdppcln + 
...
interplot(mm.elintim.engaged.raw, var1="defacto.attack.lag", var2="engaged.society.lag") #No effect



##State owernship of economy
mm.elirreg.base.raw <- lmer(v2elirreg.inv~defacto.attack.lag + v2clstown +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elirreg.stown.raw <- lmer(v2elirreg.inv~defacto.attack.lag + v2clstown + 
                               defacto.attack.lag:v2clstown +
                               elexec + #e_peaveduc+ 
                               e_polity2 +
                               e_migdppcln + 
                               e_miurbani + 
...
interplot(mm.elirreg.stown.raw, var1="defacto.attack.lag", var2="v2clstown")  #High state ownership + attack = more irregularity; and vice versa; same is true of boost to JI (oddly)

###

mm.elintim.base.raw <- lmer(v2elintim.inv~defacto.attack.lag + v2clstown +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elintim.stown.raw <- lmer(v2elintim.inv~defacto.attack.lag + v2clstown + 
                               defacto.attack.lag:v2clstown +
                               elexec + #e_peaveduc+ 
                               e_polity2 +
                               e_migdppcln + 
...
interplot(mm.elintim.stown.raw, var1="defacto.attack.lag", var2="v2clstown")  #Private owernship + boost to JI = less violence




##Opposition oversight
mm.elirreg.base.raw <- lmer(v2elirreg.inv~defacto.attack.lag + opposition.oversight.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elirreg.oppart.raw <- lmer(v2elirreg.inv~defacto.attack.lag + opposition.oversight.lag + 
                                defacto.attack.lag:opposition.oversight.lag +
                                elexec + #e_peaveduc+ 
                                e_polity2 +
                                e_migdppcln + 
                                e_miurbani + 
...
interplot(mm.elirreg.oppart.raw, var1="defacto.attack.lag", var2="opposition.oversight.lag") #No effect for attack; boost reduces fraud when oversight is low
...
##Comp
mm.elirreg.base.raw <- lmer(v2elirreg.inv~defacto.attack.lag + e_van_comp.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elirreg.comp.raw <- lmer(v2elirreg.inv~defacto.attack.lag + e_van_comp.lag + 
                              defacto.attack.lag:e_van_comp.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
interplot(mm.elirreg.comp.raw, var1="defacto.attack.lag", var2="e_van_comp.lag") #No relationship


####

mm.elintim.base.raw <- lmer(v2elintim.inv~defacto.attack.lag + e_van_comp.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elintim.comp.raw <- lmer(v2elintim.inv~defacto.attack.lag + e_van_comp.lag + 
                              defacto.attack.lag:e_van_comp.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
...
interplot(mm.elintim.comp.raw, var1="defacto.attack.lag", var2="e_van_comp.lag") #When comp is low, boost reduces violence




##regtrans
mm.elirreg.base.raw <- lmer(v2elirreg.inv~defacto.attack.lag + regtrans2.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elirreg.regtrans.raw <- lmer(v2elirreg.inv~defacto.attack.lag + regtrans2.lag + 
                                  defacto.attack.lag:regtrans2.lag +
                                  elexec + #e_peaveduc+ 
                                  e_polity2 +
                                  e_migdppcln + 
                                  e_miurbani + 
...
interplot(mm.elirreg.regtrans.raw, var1="defacto.attack.lag", var2="regtrans2.lag") #No relationship

###

mm.elintim.base.raw <- lmer(v2elintim.inv~defacto.attack.lag + regtrans2.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elintim.regtrans.raw <- lmer(v2elintim.inv~defacto.attack.lag + regtrans2.lag + 
                                  defacto.attack.lag:regtrans2.lag +
                                  elexec + #e_peaveduc+ 
                                  e_polity2 +
                                  e_migdppcln + 
...
interplot(mm.elintim.regtrans.raw, var1="defacto.attack.lag", var2="regtrans2.lag") #Attack + authoritarian shift = more intim, boost + authoritarian shift = less



##parcomp2

mm.elirreg.base.raw <- lmer(v2elirreg.inv~defacto.attack.lag + parcomp2.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elirreg.parcomp.raw <- lmer(v2elirreg.inv~defacto.attack.lag + parcomp2.lag + 
                                 defacto.attack.lag:parcomp2.lag +
                                 elexec + #e_peaveduc+ 
                                 e_polity2 +
                                 e_migdppcln + 
                                 e_miurbani + 
...
interplot(mm.elirreg.parcomp.raw, "defacto.attack.lag", "parcomp2.lag")  #Unconvincing plot

####

mm.elintim.base.raw <- lmer(v2elintim.inv~defacto.attack.lag + parcomp2.lag +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elintim.parcomp.raw <- lmer(v2elintim.inv~defacto.attack.lag + parcomp2.lag + 
                                 defacto.attack.lag:parcomp2.lag +
                                 elexec + #e_peaveduc+ 
                                 e_polity2 +
                                 e_migdppcln + 
...
interplot(mm.elintim.parcomp.raw, "defacto.attack.lag", "parcomp2.lag")  #Unconvincing plot

##parreg

mm.elirreg.base.raw <- lmer(v2elirreg.inv~defacto.attack.lag + as.factor(parreg2.lag) +
                              elexec + #e_peaveduc+ 
                              e_polity2 +
                              e_migdppcln + 
                              e_miurbani + 
...
mm.elirreg.parreg.raw <- lmer(v2elirreg.inv~defacto.attack.lag + as.factor(parreg2.lag) + 
                                defacto.attack.lag:(as.factor(parreg2.lag)) +
                                elexec + #e_peaveduc+ 
                                e_polity2 +
                                e_migdppcln + 
                                e_miurbani + 
...
interplot(mm.elirreg.parreg.raw, "defacto.attack.lag", "parreg2.lag")
...
myvars <- c("COWcode", "year", "transitional", "v2elirreg.inv", "v2elintim.inv", "lc.ind.2lag", 
            ...
            "country_name", "defacto.attack.lag", "e_migdppcln", "loggpdpc.lag",
...
cbps.out <- CBPS(defacto.attack.lag~ democracy.duration.lag + oppaut.lag +
                   e_peaveduc +
                   #e_van_comp.lag  + 
...
model.elirreg.negshockmajor.frassoc <- lmer(v2elirreg.inv~defacto.attack.lag +
                                              frassoc_thick.lag + defacto.attack.lag*frassoc_thick.lag + elexec  + 
                                              #e_polity2 +
                                              e_migdppcln + 
                                              #e_miurbani + 
                                              v2eldommon + 
...
p.cbps.irreg.frassoc <- interplot(model.elirreg.negshockmajor.frassoc, var1="defacto.attack.lag", var2="frassoc_thick.lag",
...
model.elintim.negshockmajor.frassoc <- lmer(v2elintim.inv~defacto.attack.lag +
                                              frassoc_thick.lag + defacto.attack.lag*frassoc_thick.lag + elexec  + 
                                              #e_polity2 +
                                              e_migdppcln + 
                                              #e_miurbani + 
...
p.cbps.intim.frassoc <- interplot(model.elintim.negshockmajor.frassoc, var1="defacto.attack.lag", var2="frassoc_thick.lag",
                                  hist=TRUE) + theme_bw() + labs(x="Lagged core civil society index", y="Marginal effect",
                                                                 title="Marginal Effect of Latent Judicial Independence \non Voting Irregularities") +
  geom_hline(yintercept=0, linetype=2)   #Significant positive
...
model.elirreg.negshockmajor.own <- lmer(v2elirreg.inv~defacto.attack.lag +
                                          state.ownership.lag + defacto.attack.lag*state.ownership.lag + 
                                          elexec  + 
                                          #  e_polity2 +
                                          e_migdppcln + 
...
p.cbps.irreg.stown <- interplot(model.elirreg.negshockmajor.own, var1="defacto.attack.lag", var2="state.ownership.lag",
...
model.elintim.negshockmajor.own <- lmer(v2elintim.inv~defacto.attack.lag +
                                          state.ownership.lag + defacto.attack.lag*state.ownership.lag + 
                                          elexec  + 
                                          #  e_polity2 +
                                          e_migdppcln + 
...
p.cbps.intim.stown <- interplot(model.elintim.negshockmajor.own, var1="defacto.attack.lag", var2="state.ownership.lag",
                                hist=TRUE) + theme_bw() + labs(x="Lagged state ownership", y="Marginal effect",
                                                               title="Marginal Effect of Latent Judicial Independence \non Voting Irregularities") +
  geom_hline(yintercept=0, linetype=2) 
...
model.elirreg.negshockmajor.ccs <- lmer(v2elirreg.inv~defacto.attack.lag +
                                          core.civil.society.lag + defacto.attack.lag*core.civil.society.lag + 
                                          elexec  + 
                                          #  e_polity2 +
                                          e_migdppcln + 
                                          #democracy.duration.lag + oppaut.lag +
...
p.cbps.irreg.ccs <- interplot(model.elirreg.negshockmajor.ccs, var1="defacto.attack.lag", var2="core.civil.society.lag",
                              hist=TRUE) + theme_bw() + labs(x="Lagged core civil society index", y="Marginal effect",
                                                             title="Marginal Effect of Latent Judicial Independence \non Voting Irregularities") +
  geom_hline(yintercept=0, linetype=2) 
...
model.elintim.negshockmajor.ccs <- lmer(v2elintim.inv~defacto.attack.lag +
                                          core.civil.society.lag + defacto.attack.lag*core.civil.society.lag + 
                                          elexec  + 
                                          #  e_polity2 +
                                          e_migdppcln + 
...
p.cbps.irreg.ccs <- interplot(model.elintim.negshockmajor.ccs, var1="defacto.attack.lag", var2="core.civil.society.lag",
                              hist=TRUE) + theme_bw() + labs(x="Lagged core civil society index", y="Marginal effect",
                                                             title="Marginal Effect of Latent Judicial Independence \non Voting Irregularities") +
...
#oppaut.lag
cbps.out <- CBPS(defacto.attack.lag~ democracy.duration.lag + oppaut.lag + e_peaveduc +
                   #e_van_comp.lag  + 
                   polity2.lag + #polcomp.lag + parcomp.lag +
                   loggpdpc.lag + 
                   e_miurbani +
...
model.elirreg.negshockmajor.oppaut <- lmer(v2elirreg.inv~defacto.attack.lag +
                                             oppaut.lag + defacto.attack.lag*oppaut.lag 
                                           + elexec  + 
                                             #e_polity2 +
                                             e_migdppcln + 
                                             #e_miurbani + 
...
p.cbps.irreg.oppaut <- interplot(model.elirreg.negshockmajor.oppaut, var1="defacto.attack.lag", var2="oppaut.lag",
...
model.elintim.negshockmajor.oppaut <- lmer(v2elintim.inv~defacto.attack.lag +
                                             oppaut.lag + defacto.attack.lag*oppaut.lag 
                                           + elexec  + 
                                             #e_polity2 +
                                             e_migdppcln + 
...
p.cbps.irreg.oppaut <- interplot(model.elintim.negshockmajor.oppaut, var1="defacto.attack.lag", var2="oppaut.lag",
                                 hist=TRUE) + theme_bw() + labs(x="Opposition autonomy lagged", y="Marginal effect",
                                                                title="Marginal Effect of Latent Judicial Independence \non Voting Irregularities") +
...
model.elirreg.negshockmajor.oppover <- lmer(v2elirreg.inv~defacto.attack.lag +
                                              opposition.oversight.lag + defacto.attack.lag*opposition.oversight.lag + 
                                              elexec  + 
                                              #  e_polity2 +
                                              e_migdppcln + 
                                              democracy.duration.lag + oppaut.lag +
...
p.cbps.irreg.oppover <- interplot(model.elirreg.negshockmajor.oppover, var1="defacto.attack.lag", var2="opposition.oversight.lag",
...
model.elintim.negshockmajor.oppover <- lmer(v2elintim.inv~defacto.attack.lag +
                                              opposition.oversight.lag + defacto.attack.lag*opposition.oversight.lag + 
                                              elexec  + 
                                              #  e_polity2 +
                                              e_migdppcln + 
...
p.cbps.intim.oppover <- interplot(model.elintim.negshockmajor.oppover, var1="defacto.attack.lag", var2="opposition.oversight.lag",
                                  hist=TRUE) + theme_bw() + labs(x="Opposition oversight lagged", y="Marginal effect",
                                                                 title="Marginal Effect of Latent Judicial Independence \non Voting Irregularities") +
  geom_hline(yintercept=0, linetype=2)    #Negative sig
...
model.elirreg.negshockmajor.leginvest <- lmer(v2elirreg.inv~defacto.attack.lag +
                                                leg.investigates.lag + defacto.attack.lag*leg.investigates.lag   + elexec  + 
                                                #e_polity2 +
                                                e_migdppcln + 
                                                #e_miurbani + 
                                                v2eldommon + 
...
p.cbps.irreg.leginvest <- interplot(model.elirreg.negshockmajor.leginvest, var1="defacto.attack.lag", var2="leg.investigates.lag",
...
model.elintim.negshockmajor.leginvest <- lmer(v2elintim.inv~defacto.attack.lag +
                                                leg.investigates.lag + defacto.attack.lag*leg.investigates.lag   + elexec  + 
                                                #e_polity2 +
                                                e_migdppcln + 
                                                #e_miurbani + 
...
p.cbps.intim.leginvest <- interplot(model.elintim.negshockmajor.leginvest, var1="defacto.attack.lag", var2="leg.investigates.lag",
                                    hist=TRUE) + theme_bw() + labs(x="Lagged legislative investigation", y="Marginal effect",
                                                                   title="Marginal Effect of Latent Judicial Independence \non Voting Irregularities") +
...
model.elirreg.negshockmajor.comp <- lmer(v2elirreg.inv~defacto.attack.lag +
                                           e_van_comp.lag + defacto.attack.lag*e_van_comp.lag   + elexec  + 
                                           #e_polity2 +
                                           e_migdppcln + 
                                           #e_miurbani + 
                                           v2eldommon + 
...
p.cbps.irreg.comp <- interplot(model.elirreg.negshockmajor.comp, var1="defacto.attack.lag", var2="e_van_comp.lag",
...
model.elirreg.negshockmajor.comp <- lmer(v2elirreg.inv~defacto.attack.lag +
                                         ...
                                         data = cbps.out$data) 
summary(model.elirreg.negshockmajor.comp)
p.cbps <- interplot(model.elirreg.negshockmajor.comp, var1="defacto.attack.lag", var2="e_van_comp.lag",
                    hist=TRUE) + theme_bw() + labs(x="Lagged electoral competition", y="Marginal effect",
                                                   title="Marginal Effect of Latent Judicial Independence \non Voting Irregularities") +
  geom_hline(yintercept=0, linetype=2) 
...
model.elirreg.negshockmajor.parcomp <- lmer(v2elirreg.inv~defacto.attack.lag +
                                              parcomp.lag2 + defacto.attack.lag*parcomp.lag2 + elexec  + 
                                              #e_polity2 +
                                              e_migdppcln + 
                                              #e_miurbani + 
                                              v2eldommon + 
...
p.cbps.irreg.parcomp <- interplot(model.elirreg.negshockmajor.parcomp, var1="defacto.attack.lag", var2="parcomp.lag2",
...
model.elintim.negshockmajor.parcomp <- lmer(v2elintim.inv~defacto.attack.lag +
                                              parcomp.lag2 + defacto.attack.lag*parcomp.lag2 + elexec  + 
                                              #e_polity2 +
                                              e_migdppcln + 
                                              #e_miurbani + 
...
p.cbps.intim.parcomp <- interplot(model.elintim.negshockmajor.parcomp, var1="defacto.attack.lag", var2="parcomp.lag2",
                                  hist=TRUE) + theme_bw() + labs(x="Lagged 'Polity'PARCOMP' score", y="Marginal effect",
                                                                 title="Marginal Effect of Latent Judicial Independence \non Voting Irregularities") +
  geom_hline(yintercept=0, linetype=2) 
...
model.elirreg.negshockmajor.oversight <- lmer(v2elirreg.inv~defacto.attack.lag +
                                                opposition.oversight.lag + defacto.attack.lag*opposition.oversight.lag + elexec  + 
                                                #  e_polity2 +
                                                e_migdppcln + 
                                                democracy.duration.lag + oppaut.lag +
                                                e_peaveduc +
...
p.cbps.irreg.oppover <- interplot(model.elirreg.negshockmajor.oversight, var1="defacto.attack.lag", var2="opposition.oversight.lag",
...
model.elintim.negshockmajor.oversight <- lmer(v2elintim.inv~defacto.attack.lag +
                                                opposition.oversight.lag + defacto.attack.lag*opposition.oversight.lag + elexec  + 
                                                #  e_polity2 +
                                                e_migdppcln + 
                                                democracy.duration.lag + oppaut.lag +
...
p.cbps.intim.oppover <- interplot(model.elintim.negshockmajor.oversight, var1="defacto.attack.lag", var2="opposition.oversight.lag",
                                  hist=TRUE) + theme_bw() + labs(x="Opposition oversight", y="Marginal effect",
                                                                 title="Marginal Effect of Negative JI Shock \non Voting Irregularities") +
  geom_hline(yintercept=0, linetype=2) 
...
myvars <- c("COWcode", "year", "transitional", "v2elirreg.inv", "v2elintim.inv", "lc.ind.2lag", 
            "hc.ind.2lag", "oppaut.lag", "elexec", "e_peaveduc",  
            "polity2.lag", "e_polity2", "e_miurbani", "v2elmulpar", "v2eldommon", "e_mipopula", 
            "country_name", "defacto.attack.lag", "loggpdpc.lag",
            "democracy.duration.lag", "exec.respectcon.lag", "leg.constraints.lag", 
...
model.elirreg.negshockmajor.ssdiff <- lmer(v2elirreg.inv~defacto.attack.lag +
                                             ss.diff.lag.inv + defacto.attack.lag*ss.diff.lag.inv + elexec  + 
                                             #  e_polity2 +
                                             democracy.duration.lag + oppaut.lag +
                                             e_peaveduc +
                                             #e_van_comp.lag  + 
...
p.cbps.irreg.ss <- interplot(model.elirreg.negshockmajor.ssdiff, var1="defacto.attack.lag", var2="ss.diff.lag.inv",
...
model.elintim.negshockmajor.ssdiff <- lmer(v2elintim.inv~defacto.attack.lag +
                                             ss.diff.lag.inv + defacto.attack.lag*ss.diff.lag.inv + elexec  + 
                                             #  e_polity2 +
                                             democracy.duration.lag + oppaut.lag +
                                             e_peaveduc +
...
p.cbps.intim.ss <- interplot(model.elintim.negshockmajor.ssdiff, var1="defacto.attack.lag", var2="ss.diff.lag.inv",
                             hist=TRUE) + theme_bw() + labs(x="Difference in lower-chamber seat-shares, first and second parties", y="Marginal effect",
                                                            title="Marginal Effect of Negative JI Shock \non Intimidation") +
  geom_hline(yintercept=0, linetype=2) 
...
###Entropy balancing using defacto.attack.lag as treatment (i.e. and decrease in JI)
library(ebal)
...
ebal.test <- ebalance(Treatment=dataset.matching.complete$defacto.attack.lag, X = ebal.covariates[c(-15, -16)])



# means in treatment group data
t.means <- apply(ebal.covariates[dataset.matching.complete$defacto.attack.lag==1,],2,mean)
# means in reweighted control group data
c.means.bal <- apply(ebal.covariates[dataset.matching.complete$defacto.attack.lag==0,],2,weighted.mean,w=ebal.test$w)
# means in raw data control group data
c.means <- apply(ebal.covariates[dataset.matching.complete$defacto.attack.lag==0,],2,mean)
library(stargazer)
...
dataset.matching.complete.controls <- subset(dataset.matching.complete, dataset.matching.complete$defacto.attack.lag == 0)
dataset.matching.complete.controls <- data.frame(cbind(dataset.matching.complete.controls, ebal.test$w))

dataset.matching.complete.treat <- subset(dataset.matching.complete, dataset.matching.complete$defacto.attack.lag == 1)
...
###regression
elirreg.negshockmajor.ssdiff.base <- lmer(v2elirreg.inv~defacto.attack.lag +
...
mm.elirreg.negshockmajor.ssdiff.all <- lmer(v2elirreg.inv~defacto.attack.lag +
                                              ss.diff.lag.inv + defacto.attack.lag*ss.diff.lag.inv   + elexec + 
                                              # e_polity2 +
                                              e_migdppcln + 
                                              #e_miurbani + 
...
p2 <- interplot(mm.elirreg.negshockmajor.ssdiff.all, var1="defacto.attack.lag", var2="ss.diff.lag.inv",
  ...
  geom_hline(yintercept=0, linetype=2)   #Attack -> less fraud in low comp
...
elintim.negshockmajor.ssdiff.base <- lmer(v2elintim.inv~defacto.attack.lag +
                                            ss.diff.lag.inv  + elexec + 
                                            #e_polity2 +
                                            e_migdppcln + 
                                            #e_miurbani + 
...
mm.elintim.negshockmajor.ssdiff.all <- lmer(v2elintim.inv~defacto.attack.lag +
                                              ss.diff.lag.inv + defacto.attack.lag*ss.diff.lag.inv   + elexec + 
                                              # e_polity2 +
                                              e_migdppcln + 
                                              #e_miurbani + 
...
p2.intim <- interplot(mm.elintim.negshockmajor.ssdiff.all, var1="defacto.attack.lag", var2="ss.diff.lag.inv",
                      hist=TRUE) + theme_bw() + labs(x="Prior election seat-share margin (inverse)", y="Marginal effect" , 
                                                     title="Marginal effect of negative JI shock on intentional \nvoting irregularities") +
  geom_hline(yintercept=0, linetype=2)  #Attack on JI reduces intimidation in less comp areas
...
ebal.test <- ebalance(Treatment=dataset.matching.complete$defacto.attack.lag, X = ebal.covariates[c(-14, -15)])
...
###regression
elirreg.negshockmajor.civil.base <- lmer(v2elirreg.inv~defacto.attack.lag +
...
mm.elirreg.negshockmajor.civil.all <- lmer(v2elirreg.inv~defacto.attack.lag +
                                             core.civil.society.lag + defacto.attack.lag*core.civil.society.lag   + elexec + 
                                             # e_polity2 +
                                             e_migdppcln + 
                                             #e_miurbani + 
                                             v2eldommon + 
...
p3 <- interplot(mm.elirreg.negshockmajor.civil.all, var1="defacto.attack.lag", var2="core.civil.society.lag",
                hist=TRUE) + theme_bw() + labs(x="Lagged civil society index", y="Marginal effect" , 
                                               title="Marginal effect of negative JI shock on intentional \nvoting irregularities") +
  geom_hline(yintercept=0, linetype=2) #In high CS openness areas, JI attack increases fraud, reduces in low openness
...
elintim.negshockmajor.civil.base <- lmer(v2elintim.inv~defacto.attack.lag +
                                           core.civil.society.lag + elexec + 
                                           #e_polity2 +
                                           e_migdppcln + 
                                           #e_miurbani + 
...
mm.elintim.negshockmajor.civil.all <- lmer(v2elintim.inv~defacto.attack.lag +
                                             core.civil.society.lag + defacto.attack.lag*core.civil.society.lag   + elexec + 
                                             # e_polity2 +
                                             e_migdppcln + 
                                             #e_miurbani + 
...
p3.intim <- interplot(mm.elintim.negshockmajor.civil.all, var1="defacto.attack.lag", var2="core.civil.society.lag",
                      hist=TRUE) + theme_bw() + labs(x="Lagged civil society index", y="Marginal effect" , 
                                                     title="Marginal effect of negative JI shock on intentional \nvoting irregularities") +
...
###regression
elirreg.negshockmajor.oversight.base <- lmer(v2elirreg.inv~defacto.attack.lag +
...
mm.elirreg.negshockmajor.oversight <- lmer(v2elirreg.inv~defacto.attack.lag +
                                             opposition.oversight.lag + defacto.attack.lag*opposition.oversight.lag   + elexec + 
                                             # e_polity2 +
                                             e_migdppcln + 
                                             #e_miurbani + 
...
p4 <- interplot(mm.elirreg.negshockmajor.oversight, var1="defacto.attack.lag", var2="opposition.oversight.lag",
                hist=TRUE) + theme_bw() + labs(x="Lagged opposition oversight", y="Marginal effect" , 
                                               title="Marginal effect of negative JI shock on intentional \nvoting irregularities") +
  geom_hline(yintercept=0, linetype=2)   #When opp oversight is low, an attack reduces fraud; increases it when opp is high
...
elintim.negshockmajor.oversight.base <- lmer(v2elintim.inv~defacto.attack.lag +
                                               opposition.oversight.lag + elexec + 
                                               #e_polity2 +
                                               e_migdppcln + 
                                               #e_miurbani + 
...
mm.elintim.negshockmajor.oversight <- lmer(v2elintim.inv~defacto.attack.lag +
                                             opposition.oversight.lag + defacto.attack.lag*opposition.oversight.lag   + elexec + 
                                             # e_polity2 +
                                             e_migdppcln + 
                                             #e_miurbani + 
...
p4.intim <- interplot(mm.elintim.negshockmajor.oversight, var1="defacto.attack.lag", var2="opposition.oversight.lag",
                      hist=TRUE) + theme_bw() + labs(x="Lagged opposition oversight", y="Marginal effect" , 
                                                     title="Marginal effect of negative JI shock on intentional \nvoting irregularities") +
  geom_hline(yintercept=0, linetype=2)  #No real effect
...
###regression
ols.elirreg.negshockmajor.comp.all <- lm(v2elirreg.inv~defacto.attack.lag +
                                           polcomp.lag2 + defacto.attack.lag*polcomp.lag2 + elexec + 
                                           #e_polity2 +
                                           e_migdppcln + 
                                           #e_miurbani + 
                                           v2eldommon + 
...
p1 <- interplot(ols.elirreg.negshockmajor.comp.all, var1="defacto.attack.lag", var2="polcomp.lag2",
                hist=TRUE) + theme_bw() + labs(x="Lagged electoral competition", y="Marginal effect") + geom_hline(yintercept=0, linetype=2) 


mm.elirreg.negshockmajor.polcomp <- lmer(v2elirreg.inv~defacto.attack.lag +
                                           polcomp.lag2 + defacto.attack.lag*polcomp.lag2   + elexec + 
                                           # e_polity2 +
                                           e_migdppcln + 
                                           #e_miurbani + 
...
p.polcomp <- interplot(mm.elirreg.negshockmajor.polcomp, var1="defacto.attack.lag", var2="polcomp.lag2",
                       hist=TRUE) + theme_bw() + labs(x="Lagged political competition", y="Marginal effect" , 
                                                      title="Marginal effect of negative JI shock on intentional \nvoting irregularities") +
  geom_hline(yintercept=0, linetype=2) #Attacks reduce fraud in low comp settings
...
###regression
ols.elirreg.negshockmajor.comp.all <- lm(v2elirreg.inv~defacto.attack.lag +
                                           state.ownership.lag + defacto.attack.lag*state.ownership.lag + elexec + 
                                           #e_polity2 +
                                           e_migdppcln + 
                                           #e_miurbani + 
                                           v2eldommon + 
                                         ...
                                         data = dataset.matching.complete.w)
summary(ols.elirreg.negshockmajor.comp.all)
p1 <- interplot(ols.elirreg.negshockmajor.comp.all, var1="defacto.attack.lag", var2="state.ownership.lag",
                hist=TRUE) + theme_bw() + labs(x="Lagged electoral competition", y="Marginal effect") + geom_hline(yintercept=0, linetype=2) 


mm.elirreg.negshockmajor.stateown <- lmer(v2elirreg.inv~defacto.attack.lag +
                                            state.ownership.lag + defacto.attack.lag*state.ownership.lag   + elexec + 
                                            # e_polity2 +
                                            e_migdppcln + 
                                            #e_miurbani + 
...
p.stateowned <- interplot(mm.elirreg.negshockmajor.stateown, var1="defacto.attack.lag", var2="state.ownership.lag",
...
###regression
ols.elirreg.negshockmajor.comp.all <- lm(v2elirreg.inv~defacto.attack.lag +
                                           diagacc.lag + defacto.attack.lag*diagacc.lag + elexec + 
                                           #e_polity2 +
                                           e_migdppcln + 
                                           #e_miurbani + 
                                           v2eldommon + 
                                         ...
                                         data = dataset.matching.complete.w)
summary(ols.elirreg.negshockmajor.comp.all)
p1 <- interplot(ols.elirreg.negshockmajor.comp.all, var1="defacto.attack.lag", var2="diagacc.lag",
                hist=TRUE) + theme_bw() + labs(x="Lagged electoral competition", y="Marginal effect") + geom_hline(yintercept=0, linetype=2) 


mm.elirreg.negshockmajor.diag <- lmer(v2elirreg.inv~defacto.attack.lag +
                                        diagacc.lag + defacto.attack.lag*diagacc.lag   + elexec + 
                                        # e_polity2 +
                                        e_migdppcln + 
                                        #e_miurbani + 
...
p.diag <- interplot(mm.elirreg.negshockmajor.diag, var1="defacto.attack.lag", var2="diagacc.lag",
                    hist=TRUE) + theme_bw() + labs(x="Diagonal accountability (lagged)", y="Marginal effect" , 
                                                   title="Marginal effect of negative JI shock on intentional \nvoting irregularities") +
  geom_hline(yintercept=0, linetype=2) #Low accountability + attack = reduced fraud, high accountability + attack = increased


###

mm.elintim.negshockmajor.diag <- lmer(v2elintim.inv~defacto.attack.lag +
                                        diagacc.lag + defacto.attack.lag*diagacc.lag   + elexec + 
                                        # e_polity2 +
                                        e_migdppcln + 
                                        #e_miurbani + 
...
p.diag.intim <- interplot(mm.elintim.negshockmajor.diag, var1="defacto.attack.lag", var2="diagacc.lag",
                          hist=TRUE) + theme_bw() + labs(x="Diagonal accountability (lagged)", y="Marginal effect" , 
                                                         title="Marginal effect of negative JI shock on intentional \nvoting irregularities") +
  geom_hline(yintercept=0, linetype=2)  #Same as above
...
###regression
ols.elirreg.negshockmajor.comp.all <- lm(v2elirreg.inv~defacto.attack.lag +
                                           parreg2.lag + defacto.attack.lag*parreg2.lag + elexec + 
                                           #e_polity2 +
                                           e_migdppcln + 
                                           #e_miurbani + 
                                           v2eldommon + 
                                         ...
                                         data = dataset.matching.complete.w)
summary(ols.elirreg.negshockmajor.comp.all)
p1 <- interplot(ols.elirreg.negshockmajor.comp.all, var1="defacto.attack.lag", var2="opposition.oversight.lag",
                hist=TRUE) + theme_bw() + labs(x="Lagged electoral competition", y="Marginal effect") + geom_hline(yintercept=0, linetype=2) 


mm.elirreg.negshockmajor.comp.all <- lmer(v2elirreg.inv~defacto.attack.lag +
                                            parreg2.lag + defacto.attack.lag*parreg2.lag   + elexec + 
                                            # e_polity2 +
                                            e_migdppcln + 
                                            #e_miurbani + 
...
p2 <- interplot(mm.elirreg.negshockmajor.comp.all, var1="defacto.attack.lag", var2="parreg2.lag",
                hist=TRUE) + theme_bw() + labs(x="Lagged electoral competition", y="Marginal effect" , 
                                               title="Marginal effect of negative JI shock on intentional \nvoting irregularities") +
  geom_hline(yintercept=0, linetype=2) 
...
###regression
ols.elirreg.negshockmajor.comp.all <- lm(v2elirreg.inv~defacto.attack.lag +
                                           parcomp2.lag + defacto.attack.lag*parcomp2.lag + elexec + 
                                           #e_polity2 +
                                           e_migdppcln + 
                                           #e_miurbani + 
                                           v2eldommon + 
...
mm.elirreg.negshockmajor.comp.all <- lmer(v2elirreg.inv~defacto.attack.lag +
                                          ...
                                          data = dataset.matching.complete.w)
summary(mm.elirreg.negshockmajor.comp.all)
p2 <- interplot(mm.elirreg.negshockmajor.comp.all, var1="defacto.attack.lag", var2="parcomp2.lag",
                hist=TRUE) + theme_bw() + labs(x="Lagged electoral competition", y="Marginal effect" , 
                                               title="Marginal effect of negative JI shock on intentional \nvoting irregularities") +
  geom_hline(yintercept=0, linetype=2) #Attack in low parcomp = less fraud, attack in high comp = more
...
####Plot of lji.2lag and defacto.attack.lag
p.levels <- qplot(lji.2lag, jitter(defacto.attack.lag), data=vdem.nodems, xlab="Latent judicial independence (lagged)",
