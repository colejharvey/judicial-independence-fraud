...
#####Loading dataset####
vdem.nodems <- read.csv("./vdem-2018-no-dems-parreg-post1945-oct2020-condensed-tidy.csv") #For broader sample
...
```{r histogram}
p.hist <- ggplot(vdem.nodems.elections, aes(parreg.lag, fill = factor(reform_positive.lag))) + geom_histogram(bins = 18) + 
                   guides(fill = guide_legend(title = "Treatment")) + labs(x = "Competitiveness of participation", y = "Count") + scale_fill_grey() + theme_bw()
...
myvars <- c("COW.factor", "year.factor", "transitional", "v2elirreg.inv", "v2elintim.inv", "lc.ind.2lag", "hc.ind.2lag", "oppaut.2lag", "elexec", "education.2lag",  "v2elparlel_1", "v2elparlel_2",                        "h_polcon3.lag", "h_polcon3.2lag",
