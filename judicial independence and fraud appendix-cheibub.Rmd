...
vdem.nodems <- read.csv("./vdem-2018-no-dems-cheibub-post1945-oct2020-condensed-tidy.csv")
...
for(i in 1:nrow(vdem.nodems.elections)){
  tryCatch({
    cow <- as.numeric(vdem.nodems.elections$COWcode[i])
...
elvb.posreform.oversight.base <- lm(v2elvotbuy.inv~reform_positive.lag +
                                               opposition.oversight.lag + elexec +  as.factor(v2elparlel)+
                                               #e_polity2 +
                                           loggpdpc.lag + 
                                               #e_miurbani + 
                                               v2eldommon + 
...
elvb.posreform.oversight.int <- lm(v2elvotbuy.inv~reform_positive.lag +
                                             opposition.oversight.lag + reform_positive.lag*opposition.oversight.lag   + elexec + as.factor(v2elparlel) +
                                             # e_polity2 +
                                         loggpdpc.lag + 
                                             #e_miurbani + 
                                             v2eldommon + 
...
myvars <- c("COWcode", "v2elirreg.inv", "democracy.duration.2lag", "oppaut.2lag", "opp.oversight.2lag",  "v2elintmon", "v2elparlel_1",  "v2elparlel_2", "reform_negative.lag",
            "opposition.oversight.lag",
            "loggpdpc.2lag", "urban.2lag",
            "hc.ind.2lag",  "lc.ind.2lag", "transitional", "exec.respectcon.2lag", "altinfo.2lag", "education.2lag",
...
```{r cbps polity}
myvars <- c("COWcode", "v2elirreg.inv", "democracy.duration.2lag", "oppaut.2lag",  "polity2.adj.2lag", "polity2.adj.lag", "v2elintmon", "v2elparlel_1", "v2elparlel_2", "reform_negative.lag",
            "loggpdpc.2lag", "urban.2lag",
            "hc.ind.2lag",  "lc.ind.2lag", "transitional", "exec.respectcon.2lag", "altinfo.2lag", "education.2lag",
            "leg.constraints.2lag", "reform_positive.lag", "elexec", "loggpdpc.2lag", "loggpdpc.lag", "v2eldommon", "e_mipopula")
...
Elcomp
```{r cbps elcomp}
myvars <- c("COWcode", "v2elirreg.inv", "democracy.duration.2lag", "oppaut.2lag",  "elcompindex.m.2lag", "elcompindex.m.lag",  "v2elintmon", "v2elparlel_1", "v2elparlel_2", "reform_negative.lag", 
            "loggpdpc.2lag", "urban.2lag",
            "hc.ind.2lag",  "lc.ind.2lag", "transitional", "exec.respectcon.2lag", "altinfo.2lag", "education.2lag",
            "leg.constraints.2lag", "reform_positive.lag", "elexec", "loggpdpc.2lag", "loggpdpc.lag", "v2eldommon", "e_mipopula")
...
p.cbps.irreg.polity <- interplot(model.elirreg.negshockmajor.polity, var1="reform_positive.lag", var2="elcompindex.m.lag",
                              hist=TRUE, adjCI = TRUE) + theme_bw() + labs(x="Lagged adjusted Polity score", y="Marginal effect",
                                                             title="Marginal effect of positive judicial reform \non voting irregularities") +
  geom_hline(yintercept=0, linetype=2) 
...
```{r cbps polcon}
myvars <- c("COWcode", "v2elirreg.inv", "democracy.duration.2lag", "oppaut.2lag",  "h_polcon3.2lag", "h_polcon3.lag",  "v2elintmon", "v2elparlel_1", "v2elparlel_2", "reform_negative.lag", 
            "loggpdpc.2lag", "urban.2lag",
            "hc.ind.2lag",  "lc.ind.2lag", "transitional", "exec.respectcon.2lag", "altinfo.2lag", "education.2lag",
            "leg.constraints.2lag", "reform_positive.lag", "elexec", "loggpdpc.2lag", "loggpdpc.lag", "v2eldommon", "e_mipopula")
...
model.elirreg.negshockmajor.polity <- lm(v2elirreg.inv~reform_positive.lag +
                                             h_polcon3.lag + reform_positive.lag*h_polcon3.lag   + elexec + 
                                             # e_polity2 +
                                             loggpdpc.lag + 
                                             #e_miurbani + 
                                              + v2elintmon + v2elparlel_1 + v2elparlel_2  + reform_negative.lag +  
...
p.cbps.irreg.polcon <- interplot(model.elirreg.negshockmajor.polity, var1="reform_positive.lag", var2="h_polcon3.lag",
...
```{r cbps polity}
myvars <- c("COWcode", "v2elirreg.inv", "democracy.duration.2lag", "oppaut.2lag",  "uds.mean.2lag", "uds.mean.lag", "v2elintmon", "v2elparlel_1", "v2elparlel_2", "reform_negative.lag",
            "loggpdpc.2lag", "urban.2lag",
            "hc.ind.2lag",  "lc.ind.2lag", "transitional", "exec.respectcon.2lag", "altinfo.2lag", "education.2lag",
            "leg.constraints.2lag", "reform_positive.lag", "elexec", "loggpdpc.2lag", "loggpdpc.lag", "v2eldommon", "e_mipopula")
...
model.elirreg.negshockmajor.polity <- lm(v2elirreg.inv~reform_positive.lag +
                                             uds.mean.lag + reform_positive.lag*uds.mean.lag   + elexec  +
                                             # e_polity2 +
                                             loggpdpc.lag + 
                                             #e_miurbani + 
                                              + v2elintmon + v2elparlel_1 + v2elparlel_2  + reform_negative.lag +  
...
p.cbps.irreg.uds <- interplot(model.elirreg.negshockmajor.polity, var1="reform_positive.lag", var2="uds.mean.lag",
...
p3.app <- interplot(mm.elirreg.posreform.polity.all, var1="reform_positive.lag", var2="polity2.adj.lag",
...
myvars <- c("COWcode", "year", "transitional", "v2elirreg.inv", "v2elintim.inv", "lc.ind.2lag", 
            ...
            "country_name", "reform_positive.lag", "loggpdpc.2lag",
            "democracy.duration.2lag", "exec.respectcon.2lag", "leg.constraints.2lag", 
            "altinfo.2lag", "loggpdpc.lag", "years.since.election", "v2elparlel", "govseat.frac.lag")  # "e_van_comp.lag  , "party.institutionalization.lag" ....... "parcomp.lag", "polcomp.lag"
...
```{r}
stargazer(elirreg.posreform.polity.base, mm.elirreg.posreform.polity.all, elirreg.posreform.oversight.base,
...
m.selection2 <- glm(reform_positive ~ democracy.duration.2lag + oppaut.2lag + 
            ...
            loggpdpc.2lag + urban.2lag +
            hc.ind.2lag +  lc.ind.2lag + transitional + exec.respectcon.2lag +
              altinfo.2lag + education.2lag + leg.constraints.2lag + govseat.frac.lag, 
            data = vdem.nodems.elections,
            family=binomial(link="logit"))
