...
#####Loading dataset####
vdem.nodems <- read.csv("./vdem-2018-no-dems-cheibub-post1945-oct2020-condensed-tidy.csv") #For broader sample
...
p1 <- interplot(model.2wfe, var1="reform_positive.lag", var2="elcompindex.m.lag",
...
model.2wfe.hpolcon.c <- lm(v2elirreg.inv ~ COW.factor + year.factor + reform_positive.lag + 
...
p.polcon <- interplot(model.2wfe.hpolcon.c, var1="reform_positive.lag", var2="h_polcon3.lag",
                      hist=TRUE, adjCI = TRUE) + theme_bw() + labs(x="Electoral competition multiplicative index (1-year lag)", y="Marginal effect") +
...
model.2wfe.legov.c <- lm(v2elirreg.inv ~ COW.factor + year.factor + reform_positive.lag + 
                   ...
                   elexec +  v2elintmon + v2elparlel_1 + v2elparlel_2 + v2elparlel_3 + reform_negative.lag, data = vdem.nodems.elections)
...
myvars <- c("COW.factor", "year.factor", "transitional", "v2elirreg.inv", "v2elintim.inv", "lc.ind.2lag", "hc.ind.2lag", "oppaut.2lag", "elexec", "education.2lag",  "v2elparlel_1", "v2elparlel_2",  "v2elparlel_3",
            "polity2.adj.lag", "polity2.adj.2lag", "urban.2lag",  "v2elintmon", "e_mipopula", 
            "country_name", "reform_positive.lag", "loggpdpc.2lag", "reform_negative.lag", "reform_negative.2lag",
...
elirreg.posreform.polity.base <- lm(v2elirreg.inv~reform_positive.lag +
                                        ...
                                        loggpdpc.lag + 
                                            #e_miurbani + 
                                            v2elintmon +  
                                            log(e_mipopula) + reform_negative.lag +
                                      COW.factor, 
                                    weights=ebal.test.w,  
...
```{r plot ebal polity}
p3.polity <- interplot(mm.elirreg.posreform.polity.all, var1="reform_positive.lag", var2="polity2.adj.lag",
                hist=TRUE, adjCI = TRUE) + theme_bw() + labs(x="Electoral competition multiplicative index (1-year lag)", y="Marginal effect") +
...
p3.bin <- inter.binning(data=dataset.matching.complete.w, Y = "v2elirreg.inv", D = "reform_positive.lag", X = "polity2.adj.lag",
              Z = c("elexec", "loggpdpc.lag", "v2elintmon", "e_mipopula", "v2elparlel_1", "v2elparlel_2", "v2elparlel_3", "reform_negative.lag"), weights = "ebal.test.w", na.rm=TRUE,  ylab = "Marginal effect", xlab = "Adjusted Polity score (lag)", theme.bw = T, cex.lab = .75, cex.axis = .75, bin.labs = F)
...
myvars <- c("COW.factor", "year.factor", "transitional", "v2elirreg.inv", "v2elintim.inv", "lc.ind.2lag", "hc.ind.2lag", "oppaut.2lag", "elexec", "education.2lag",  "v2elparlel_1", "v2elparlel_2",  "v2elparlel_3",
            "elcompindex.m.lag", "elcompindex.m.2lag", "urban.2lag",  "v2elintmon", "e_mipopula", 
...
lrtest(mm.elirreg.posreform.elcomp.base, mm.elirreg.posreform.elcomp.all)

```

```{r plot ebal polity}
p3.elcomp <- interplot(mm.elirreg.posreform.elcomp.all, var1="reform_positive.lag", var2="elcompindex.m.lag",
                hist=TRUE, adjCI = TRUE) + theme_bw() + labs(x="Electoral competition multiplicative index (1-year lag)", y="Marginal effect") +
  geom_hline(yintercept=0, linetype=2)   #No effect for fraud
p3.elcomp
...
p3.bin <- inter.binning(data=dataset.matching.complete.w, Y = "v2elirreg.inv", D = "reform_positive.lag", X = "elcompindex.m.lag",
              Z = c("elexec", "loggpdpc.lag", "v2elintmon", "e_mipopula", "v2elparlel_1", "v2elparlel_2", "v2elparlel_3"), weights = "ebal.test.w", na.rm=TRUE,  ylab = "Marginal effect", xlab = "Adjusted Polity score (lag)", theme.bw = T, cex.lab = .75, cex.axis = .75, bin.labs = F)
...
elirreg.posreform.oversight.base <- lm(v2elirreg.inv~reform_positive.lag +
                                           ...
                                           loggpdpc.lag + 
                                               #e_miurbani + 
                                               v2eldommon + 
                                               log(e_mipopula)  +  v2elparlel_1 + v2elparlel_2 +  reform_negative.lag +
...
```{r ebal polity, include=FALSE}
myvars <- c("COW.factor", "year.factor", "transitional", "v2elirreg.inv", "v2elintim.inv", "lc.ind.2lag", "hc.ind.2lag", "oppaut.2lag", "elexec", "education.2lag",  "v2elparlel_1", "v2elparlel_2",  "v2elparlel_3",
            "uds.mean.lag", "uds.mean.2lag", "urban.2lag",  "v2elintmon", "e_mipopula", 
            "country_name", "reform_positive.lag", "loggpdpc.2lag", "reform_negative.lag",
            "democracy.duration.2lag", "exec.respectcon.2lag", "leg.constraints.2lag", 
            "altinfo.2lag", "loggpdpc.lag")  # "e_van_comp.lag  , "party.institutionalization.lag" ....... "parcomp.lag", "polcomp.lag"
...
elirreg.posreform.polity.base <- lm(v2elirreg.inv~reform_positive.lag +
                                        ...
                                        uds.mean.lag  + elexec +  v2elparlel_1 + v2elparlel_2 + 
                                            #e_polity2 +
                                        loggpdpc.lag + 
                                            #e_miurbani + 
                                            v2elintmon +  
...
```{r plot ebal uds}
interactions::sim_slopes(mm.elirreg.posreform.polity.all, pred = reform_positive.lag, modx = uds.mean.lag, jnplot = TRUE)


plot_model(mm.elirreg.posreform.polity.all, type="eff", terms = c("uds.mean.lag", "reform_positive.lag"))

p4.uds <- interplot(mm.elirreg.posreform.polity.all, var1="reform_positive.lag", var2="uds.mean.lag",
                hist=TRUE, adjCI = TRUE) + theme_bw() + labs(x="Unified Democracy Score (1-year lag)", y="Marginal effect") +
  geom_hline(yintercept=0, linetype=2)   
p4.uds
```
...
myvars <- c("COW.factor", "year.factor", "transitional", "v2elirreg.inv", "v2elintim.inv", "lc.ind.2lag", "hc.ind.2lag", "oppaut.2lag", "elexec", "education.2lag",  "v2elparlel_1", "v2elparlel_2",  "v2elparlel_3",                        "h_polcon3.lag", "h_polcon3.2lag",
             "urban.2lag",  "v2elintmon", "e_mipopula", 
            "country_name", "reform_positive.lag", "loggpdpc.2lag", "reform_negative.lag",
            "democracy.duration.2lag", "exec.respectcon.2lag", "leg.constraints.2lag", 
            "altinfo.2lag", "loggpdpc.lag")  # "e_van_comp.lag  , "party.institutionalization.lag" ....... "parcomp.lag", "polcomp.lag"
...
myvars <- c("democracy.duration.2lag", "oppaut.2lag",  "h_polcon3.2lag",
             "loggpdpc.2lag", "urban.2lag",
            "hc.ind.2lag",  "lc.ind.2lag", "transitional", "exec.respectcon.2lag", "altinfo.2lag", "education.2lag",
            "leg.constraints.2lag")  #"lji.lag"
ebal.covariates <- dataset.matching.complete[myvars]
...
elirreg.posreform.polcon.base <- lm(v2elirreg.inv~reform_positive.lag +
                                        ...
                                        h_polcon3.lag  + elexec +  v2elparlel_1 + v2elparlel_2 + v2elparlel_3 +
                                            #e_polity2 +
                                        loggpdpc.lag + 
                                            #e_miurbani + 
                                            v2elintmon +  
...
mm.elirreg.posreform.polcon.all <- lm(v2elirreg.inv~reform_positive.lag
                                      ...
                                      + elexec + v2elparlel_1 + v2elparlel_2 + v2elparlel_3 +
                                              # e_polity2 +
                                          loggpdpc.lag + 
                                              #e_miurbani + 
                                              v2elintmon + 
...
p.combined.ints <- plot_grid(p1.kernel.image, p2.kernel.image, p3.kernel.image, p4.kernel.image, align = "hv", nrow = 2, label_size = 12, hjust = 0)
p.combined.ints
